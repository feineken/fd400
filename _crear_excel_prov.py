...
headers = [
    "RUT", "DV", "Nombre", "Banco", "Cuenta",
    "MedioPago", "Monto", "Descripcion",
    "Email", "GlosaMensaje",
    "GlosaFact1", "MontoFact1",
    "GlosaFact2", "MontoFact2",
    "GlosaFact3", "MontoFact3",
    "GlosaFact4", "MontoFact4",
]
ws.append(headers)
...
anchos = [13, 4, 42, 8, 20, 12, 12, 30, 30, 35, 25, 12, 25, 12, 25, 12, 25, 12]
...
wb.save("proveedores_template.xlsx")
print("OK: proveedores_template.xlsx")
print("   Hoja: Proveedores | Columnas A-R | Dropdowns en D y F")
print("   Columnas opcionales: I (Email), J (GlosaMensaje), K-R (hasta 4 facturas)")
